...
def entryfield(identifier,row,column):
    ...
    memory[identifier].grid(row=row,column=column,sticky=tk.W,padx=padx(**kwargs),pady=pady(**kwargs))
...
def checkbox(identifier,text,row,column):
    ...
    memory[text].grid(row=row,column=column,sticky=tk.W,padx=padx(**kwargs),pady=pady(**kwargs))
...
def radiobox(default,text,value,row,column):
    ...
    radiob.grid(row=row,column=column,sticky=tk.W,padx=padx(**kwargs),pady=pady(**kwargs))
...
def dropdownlist(choices,variable,default,row,column):
    ...
    popupmenu.grid(row=row,column=column,sticky=tk.W,padx=padx(**kwargs),pady=pady(**kwargs))
