...
config(size="600x300+500+200",background="brown",icon="icon.ico")
...
checkbox(name="ch1",text="checkbox 1",background="brown",row=2,column=0,sticky="left",padx=5,pady=5)
checkbox(name="ch2",text="checkbox 2",background="brown",row=3,column=0,sticky="left",padx=5,pady=5)
